...
We will use getData from the raster package. We will work on migrating towards CMIP6, which will require a different data download method in the future. For now, this will work. You can specify which rcp, which is the greenhouse gas emission prediction. You can also specify which [climate model](https://rdrr.io/cran/raster/man/getData.html) you'd like to use, how many years into the future: 50 or 70 years from now. 
```{r}
